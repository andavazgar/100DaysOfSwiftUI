...
| **Project 5:** *[WordScramble](WordScramble)*<br><sub>_Views: `List`<br>Modifiers: `onAppear()`<br>`Bundle`, `fatalError()`, `UITextChecker`_</sub> | ![Screenshots](WordScramble/Screenshots/Thumbnails/Combined.png) |